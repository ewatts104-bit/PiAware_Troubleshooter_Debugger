...
SAFE_PATTERNS = [
    ...
    r"^systemctl\s+(status|restart|stop|start|is-active|is-enabled)\s+(piaware|dump1090-fa|dump978-fa|readsb)$",
    r"^sudo\s+systemctl\s+(status|restart|stop|start|is-active|is-enabled)\s+(piaware|dump1090-fa|dump978-fa|readsb)$",
    r"^journalctl\s+-u\s+(piaware|dump1090-fa|dump978-fa|readsb)(\s+[-\w\s=]+)?$",
